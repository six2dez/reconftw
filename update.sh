...
#Tools to be updated
repos="s0md3v/Arjun six2dez/degoogle_hunter 1ndianl33t/Gf-Patterns gwen001/github-search eslam3kl/crtfinder dark-warlord14/LinkFinder devanshbatham/ParamSpider Threezh1/JSFinder haccer/subjack s0md3v/Corsy Tuhinshubhra/CMSeeK pielco11/fav-up tomnomnom/gf codingo/Interlace blechschmidt/massdns devanshbatham/OpenRedireX obheda12/GitDorker"
printf "\n${bgreen}--==[ ************************************************************************************ ]==--\n"
...
eval wget -N -c -O $dir/resolvers.txt https://raw.githubusercontent.com/bp0lr/dmut-resolvers/main/resolvers.txt $DEBUG_STD
