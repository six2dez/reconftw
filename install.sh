...
if [ "True" = "$IS_ARM" ]; then
    if [ "True" = "$RPI_3" ]; then
        ...
        eval wget -N -c https://github.com/Edu4rdSHL/unimap/releases/download/0.5.1/unimap-armv7 $DEBUG_STD
        ...
        eval wget -N -c https://github.com/Edu4rdSHL/unimap/releases/download/0.5.1/unimap-aarch64 $DEBUG_STD
    ...
    eval wget -N -c https://github.com/Edu4rdSHL/unimap/releases/download/0.5.1/unimap-linux $DEBUG_STD
