...
eval git clone https://github.com/x90skysn3k/brutespray $dir/brutespray $DEBUG_STD
eval git clone https://github.com/vortexau/dnsvalidator $dir/dnsvalidator $DEBUG_STD
...
cd $dir/dnsvalidator && eval $SUDO python3 setup.py install $DEBUG_STD
cd $dir
...
eval wget -O subdomains_big.txt https://s3.amazonaws.com/assetnote-wordlists/data/manual/best-dns-wordlist.txt
eval wget -O subdomains_big2.txt https://gist.githubusercontent.com/jhaddix/86a06c5dc309d08580a018c66354a056/raw/96f4e51d96b2203f19f6381c8c545b278eaa0837/all.txt $DEBUG_STD
